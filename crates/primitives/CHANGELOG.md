...
## [16.0.0](https://github.com/leovct/revm/compare/revm-primitives-v15.1.0...revm-primitives-v16.0.0) - 2025-02-04
...
- fix eip3155 summary gas_used bug and add fork name ([#1216](https://github.com/leovct/revm/pull/1216))
...
- Revert "Revert "feat: implement EIP-2935 ([#1354](https://github.com/leovct/revm/pull/1354))" ([#1424](https://github.com/leovct/revm/pull/1424))" ([#1426](https://github.com/leovct/revm/pull/1426))
- Revert "feat: implement EIP-2935 ([#1354](https://github.com/leovct/revm/pull/1354))" ([#1424](https://github.com/leovct/revm/pull/1424))
- release (#1261)
- bump c-kzg to 1.0.2 (#1390)
- refactor lints (#1386)
- add blob_count and max_blobs to `TooManyBlobs` err enum (#1375)
- bump alloy & specify dep rev ([#1380](https://github.com/leovct/revm/pull/1380))
- don't clone bytes in `Bytecode::bytes` (#1344)
- shrink OpCodeInfo and add more methods (#1307)
- Implement `with_chain_id` for `CfgEnv` ([#1327](https://github.com/leovct/revm/pull/1327))
- *(interpreter)* remove EOF branch in CODE{SIZE,COPY} (#1308)
- Update documentation ([#1275](https://github.com/leovct/revm/pull/1275))
- release (#1231)
...
- Add docs to `optimism` `InvalidTransaction` errors. ([#884](https://github.com/leovct/revm/pull/884))
...
- cargo fmt and removed extra newlines ([#860](https://github.com/leovct/revm/pull/860))
- Fix error message for LackOfFundForMaxFee ([#858](https://github.com/leovct/revm/pull/858))
...
- include alloy-primitives std feature ([#788](https://github.com/leovct/revm/pull/788))
- *(primitives)* OptimismFields Docs Cleanup (#778)
- Remove dead state trait function ([#779](https://github.com/leovct/revm/pull/779))
- Verify account is empty checks ([#780](https://github.com/leovct/revm/pull/780))
- *(primitives)* Clean up the account typs with docs (#776)
- Use upstream create and create2 implementations ([#775](https://github.com/leovct/revm/pull/775))
- Implement display and error for precompile error ([#777](https://github.com/leovct/revm/pull/777))
...
- Improve wording and fix typos ([#749](https://github.com/leovct/revm/pull/749))
- BLOBBASEFEE opcode (#721)
- error type for block header (#731)
- document when InvalidTransaction errors are thrown ([#722](https://github.com/leovct/revm/pull/722))
...
- Small doc comment fix ([#698](https://github.com/leovct/revm/pull/698))
...
- Fix typo in primitives/src/state.rs ([#474](https://github.com/leovct/revm/pull/474))
- Release v22, revm v3.1.1 ([#460](https://github.com/leovct/revm/pull/460))
- add into_logs (#453)
- v21, revm v3.1.0 (#444)
- bump all
- add feature for ignoring base fee check ([#436](https://github.com/leovct/revm/pull/436))
- Comment Fix ([#430](https://github.com/leovct/revm/pull/430))
- *(deps)* bump arbitrary from 1.2.3 to 1.3.0 (#428)
- enabled primtive default feature in precompile (#409)
- Update readmdoc of `perf_analyse_created_bytecodes` ([#404](https://github.com/leovct/revm/pull/404))
- remove gas blocks (#391)
- impl NonceTooHigh/ NonceTooLow checks ([#383](https://github.com/leovct/revm/pull/383))
- derive Debug for DatabaseComponentError (#377)
- Add B160/B256 From primitive_types traits ([#380](https://github.com/leovct/revm/pull/380))
...
- nits and num of cargo keyword to 5 ([#351](https://github.com/leovct/revm/pull/351))
...
- expose hashbrown::HashMap in primitives ([#345](https://github.com/leovct/revm/pull/345))
