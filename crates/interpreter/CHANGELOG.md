...
## [17.1.0](https://github.com/leovct/revm/compare/revm-interpreter-v17.0.0...revm-interpreter-v17.1.0) - 2025-04-03

### Added

- *(tests)* Add dupn, swapn and exhange tests ([#2343](https://github.com/leovct/revm/pull/2343))
